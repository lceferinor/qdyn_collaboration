...
% for i=1:10
  ...
  scatter3(p.X(ind_sel)/1000+dx/2*p.NXOUT,p.Y(ind_sel)/1000+dy/2*p.NWOUT,p.Z(ind_sel)/1000+dz/2*p.NWOUT,[],1 - ox1.v(:,i)/p.V_SS,'s','filled');
  caxis([0 1]);
  mymap = [1    1    1 
      0.8  0.8  0.8
    0    1    0 
