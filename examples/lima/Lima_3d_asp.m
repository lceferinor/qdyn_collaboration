...
p.W=p.W/cos(17/180*pi); %Along dip distance
p.NX=100;
p.NW=30; % Related to question on p.W. Is this related to the contact 
         % surface? (Luis)

p.Z_CORNER=-60e3; % In Km (extracted from Nocquet, 20146). A report from 
...
p.DIP_W(1:p.NW)=17.0; % Extracted from the fault geometry (Luis)
twm=0.5;
%ts=0.5;
p.ACC = 1e-14;
