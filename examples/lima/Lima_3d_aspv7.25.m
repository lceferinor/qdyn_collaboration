...
p.DC=0.1/8*1.3; % From Tohoku, Tohoku is 0.8
...
p.NX=round(2048*2/4*1); % So that dx is smaller than Lb
p.NW=128*8/4; % So that dw is smaller than Lb
...
factor_a = 0.8;
factor_b = 0.8;
asp_elip_a = [0.214*1.0 0.335*1.35 0.294*1.4 0.243*1.0]/2*790*10^3*factor_a*1.005*0.975;% Along strike (Scaled on the previous rupture size)
asp_elip_b = [0.798*1.0 0.667*1.1 0.649*1.1 0.699*1.2]/2*p.W*factor_b*0.975;% Along dip
